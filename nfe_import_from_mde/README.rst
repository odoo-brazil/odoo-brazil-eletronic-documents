...
==================================================================
Integração entre a importação do XML e o Manifesto de destinatário
==================================================================

Este módulo realiza a integração com o Manifesto do Destinatário, com ele é
possível receber automaticamente todas as suas notas diretamente do SEFAZ
...
:%nfe_import_from_mde%0Aversion:%208
