...
class l10n_br_account_nfe_import_invoice(orm.TransientModel):
    """Import brazilian eletronic invoice from xml file"""
    _name = 'l10n_br_account.nfe_import_invoice'
    _description = 'Import brazilian eletronic invoice from xml file'
    _columns = {
        'name': fields.char('Nome', size=255),
        'file': fields.binary('Arquivo', readonly=True),
        'file_type': fields.selection(
            [('xml', 'XML')], 'Tipo do Arquivo'),
        'state': fields.selection(
            [('init', 'init'), ('done', 'done')], 'state', readonly=True),
        'nfe_environment': fields.selection(
            [('1', u'Produção'), ('2', u'Homologação')], 'Ambiente'),
        'nfe_import_result': fields.one2many(
            'l10n_br_account.nfe_import_invoice_result', 'wizard_id',
            'NFe Import Result'),
...
class l10n_br_account_nfe_import_invoice_result(orm.TransientModel):
    _name = 'l10n_br_account.nfe_import_invoice_result'
    _columns = {
